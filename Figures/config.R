...
main_f <- '/work/Neuroinformatics_Core/s204365/scRNA_0001/'        #Please set this to the main path where you wish to perform the analysis
library(pals)
### Global Directories ###
rna_sample_dir <- '/work/Neuroinformatics_Core/s204365/scRNA_0001/QC'                        # the files from the 10x scRNA run should be located here
atac_sample_dir <- '/work/Neuroinformatics_Core/s204365/scATAC_0001/outputDirectory'         # the files from the 10x scATAC run should be located here
